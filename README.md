...
- Run `/development-loop analyze-logs [path]` to summarize loop starts, blockers, empty provider responses, context overflows, compactions, topic sizes, repeated oversized topics, and likely improvement areas.
