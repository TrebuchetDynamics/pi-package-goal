...
- Latest green commit: `5a596082022eda617d5a5e6dcfdc444b954b05ea`
- Audit passes: 1
...
| F-2 | Medium | fixed | Audit root runtime dependencies in CI | .github/workflows/ci.yml:16-27 installs root runtime dependencies and audits only skills/frontend/stitch-react-components; package.json declares pi-posher as a runtime dependency. | c4350a7ee10d8c98e9962057d137e4425d0f11bf |
| F-3 | Medium | fixed | Avoid Arch Linux partial package upgrade | install.sh:77-78 runs pacman -Sy --needed --noconfirm tmux; tests/universal-install.test.mjs:59-78 only exercises the already-installed tmux path. | 7c96a4a8a2ba5ffd53ec25b65141f7210c32f376 |
