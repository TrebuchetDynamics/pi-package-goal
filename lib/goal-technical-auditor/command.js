...
export const GOAL_TECHNICAL_AUDITOR_USAGE = `Usage: /goal-technical-auditor [--tokens 200k] [--dry-run] [--focus ${BUG_HUNT_REFACTOR_FOCUS}] [scope|prompt]\nExamples: /goal-technical-auditor ., /goal-technical-auditor lib, /goal-technical-auditor bug hunt`;
