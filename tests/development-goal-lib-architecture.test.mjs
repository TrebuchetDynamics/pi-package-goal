...
assert.deepEqual(pkg.pi.extensions, ["./extensions/goal", "./extensions/understand", "./extensions/folder-refactor", "./extensions/rtk", "./extensions/graphify"], "package must register package extensions");
