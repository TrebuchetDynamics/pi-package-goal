...
assert.deepEqual(pkg.pi.extensions, ["./extensions/goal", "./extensions/goal-technical-auditor", "./extensions/understand", "./extensions/folder-refactor", "./extensions/rtk", "./extensions/headroom", "./extensions/ponytail", "./extensions/loop-engineering", "./extensions/onklaud"], "package must register package extensions");
