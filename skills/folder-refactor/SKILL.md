...
3. Propose the smallest safe folder topology, then implement in explicit move-only, extraction, and cleanup phases.
...
3. **Refactor safely**
   - Phase 1: move files and update imports only; run narrow tests/typechecks.
