...
- When `codebase-map-understand.md` exists and the web change touches existing routes/components/data flow, consult the codebase map for project-specific relationship leads before applying generic web guidance; verify named files directly.
