...
```bash
node skills/engineering/prompt-cache-auditor/scripts/summarize-cache-usage.mjs response.json
node skills/engineering/prompt-cache-auditor/scripts/summarize-cache-usage.mjs --require-read response.json
```
